<template>
    <div class="wrap">
        <Header :showRuleName="false" class="header" :ifSoltin="true" title="交易明细">
        ...
        <div class="betDetail">
            <div class="inputBox">
                <input type="text" placeholder="下级交易查询">
                <img src="./search@2x.png">
            </div>
            <p class="title" ref="title">
                <span @click="changeTab" name="1" class="on">金流类型</span>
                <span @click="changeTab" name="2">提现记录</span>
                <span @click="changeTab" name="3">充值记录</span>
            </p>
            <ul>
                <li v-for="(item,index) in dataList" :key="index">
                    ...
                    <div class="right">
                        <p class="win" v-if="item.type == 1">+{{item.mountB}}</p>
                        <p class="win" v-else-if="item.type == 2">+{{item.mountB}}</p>
                        <p class="win" v-else-if="item.type == 3">+{{item.mountB}}</p>
                        <p class="lose" v-else-if="item.type == 4">-{{item.mountB}}</p>
                        <p v-if="item.type == 1">停止追号</p>
                        <p v-else-if="item.type == 2">奖金派送</p>
                        <p v-else-if="item.type == 3">代理返点</p>
                        <p v-else-if="item.type == 4">投注扣款</p>
                    </div>
                </li>
            </ul>
